                    ...
                    <tbody>
                        ...
                        if (mysqli_num_rows($query_run) > 0) {
                            foreach ($query_run as $data) {
                                // Normalize verify value to int (default 0 if missing)
                                $verify_value = isset($data['verify']) ? (int)$data['verify'] : 0;

                                $verify_status = match ($verify_value) {
                                    0 => 'Not Verified',
                                    1 => 'Under Review',
                                    2 => 'Verified',
                                    3 => 'Partial',
                                ...
                                $verify_badge_class = match ($verify_value) {
                                    0 => 'bg-danger',
                                    1 => 'bg-warning',
                                    2 => 'bg-success',
                                    3 => 'bg-info',
                                                        ...
                                                        <form action="codes/users.php" method="POST">
                                                            ...
                                                            <div class="form-group mb-3">
                                                                ...
                                                                <select name="verify_status" class="form-control" id="verify_status_<?= $data['id'] ?>" required>
                                                                    <option value="0" <?= $verify_value === 0 ? 'selected' : '' ?>>Not Verified</option>
                                                                    <option value="1" <?= $verify_value === 1 ? 'selected' : '' ?>>Under Review</option>
                                                                    <option value="2" <?= $verify_value === 2 ? 'selected' : '' ?>>Verified</option>
                                                                    <option value="3" <?= $verify_value === 3 ? 'selected' : '' ?>>Partial</option>
                                                                </select>
                                                            </div>
...
// ...existing code...
````// filepath: c:\path\to\manage-users.php
// ...existing code...
<?php
session_start();
include('inc/header.php');
